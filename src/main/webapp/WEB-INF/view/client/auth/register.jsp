                                    ...
                                    <div class="col-lg-7">
                                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            ...
                                            <div class="card-body">
                                                <form:form action="/register" method="post"
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                                <form:input class="form-control ${not empty errorName ? 'is-invalid' : ''}" id="inputFirstName"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                                <form:input class="form-control ${not empty errorPass ? 'is-invalid' : ''}" 
                                            ...
                                            <div class="card-footer text-center py-3">
                                                <div class="small"><a href="/login">Bạn có tài khoản? quay lại Đăng Nhập</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
