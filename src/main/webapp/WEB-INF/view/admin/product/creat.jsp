                                ...
                                <div class="mt-5 mb-5">
                                    <div class="row">
                                        <div class=" col-md-6 col-12 mx-auto">
                                            ...
                                            <hr class="">
                                            <form:form enctype="multipart/form-data" modelAttribute="productnew" method="post" action="/admin/product/creat">
                                                <div class="row g-3">
                                                    <div class="col">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <form:input  type="text"  class="form-control" id="price" placeholder="0.0"
                                                            path="price" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <form:textarea type="text"  class="form-control" id="detailDesc" rows="3" path="detailDesc" />
                                                  </div>
                                                  ...
                                                  <div class="row g-3">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <form:input  type="number"  class="form-control" id="quantity" placeholder="0"
                                                            path="quantity" />
                                                    </div>
                                                </div>
